...
////	       
	    ...
	    public void login() {
	        // Default login from config.properties
	    ...
	    public void login(String username, String password) {
	        // Override with username/password passed from test
	        performLogin(username, password);
	    }
	    ...
	    public void loginByKey(String userKey) {
	        String username = prop.getProperty(userKey + "User");
	        String password = prop.getProperty(userKey + "Pass");
	        performLogin(username, password);
	    }
